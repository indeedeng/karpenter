...
var _ = AfterEach(func() {
	...
	disruption.SimulationDurationSeconds.Reset()
	...
	disruption.OldestEligibleTimestampSeconds.Reset()
	disruption.TimeoutCandidateCount.Reset()
	disruption.SimulationTopologyConstraintCount.Reset()
	disruption.SimulationTopologyKeyCount.Reset()
	disruption.SimulationPhaseDurationSeconds.Reset()
	...
	disruption.ConsolidationOpportunityEvaluationCoverageRatio.Reset()
	disruption.ConsolidationOpportunityPricingCoverageRatio.Reset()
	disruption.ConsolidationOpportunityUnpricedCandidateCount.Reset()
})
