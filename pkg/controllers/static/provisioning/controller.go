...
func NewController(kubeClient client.Client, cluster *state.Cluster, recorder events.Recorder, cloudProvider cloudprovider.CloudProvider, _ *provisioning.Provisioner, clock clock.Clock, deviceAllocationController *deviceallocation.Controller, launchBackoff *launchbackoff.Tracker) *Controller {
	return &Controller{
