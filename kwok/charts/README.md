...
| settings | object | `{"batchIdleDuration":"1s","batchMaxDuration":"10s","featureGates":{"disruptionSimulationReuse":false,"launchBackoff":false,"nodePoolDriftBackoff":true,"nodeRepair":false,"spotToSpotConsolidation":false},"minValuesPolicy":"Strict","preferencePolicy":"Respect"}` | Global Settings to configure Karpenter |
...
| settings.featureGates | object | `{"disruptionSimulationReuse":false,"launchBackoff":false,"nodePoolDriftBackoff":true,"nodeRepair":false,"spotToSpotConsolidation":false}` | Feature Gate configuration values. Feature Gates will follow the same graduation process and requirements as feature gates in Kubernetes. More information here https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-gates-for-alpha-or-beta-features |
| settings.featureGates.disruptionSimulationReuse | bool | `false` | disruptionSimulationReuse is ALPHA and is disabled by default. Setting this to true reuses immutable scheduler preparation across consolidation simulations in one method pass. |
| settings.featureGates.launchBackoff | bool | `false` | launchBackoff is ALPHA and is disabled by default. Setting this to true will bound retries independently for capacity pools that returned insufficient capacity. |
