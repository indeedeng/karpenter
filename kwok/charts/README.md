...
| settings.featureGates.launchBackoff | bool | `false` | launchBackoff is ALPHA and is disabled by default. Setting this to true bounds retries independently for capacity pools that returned insufficient capacity. |
