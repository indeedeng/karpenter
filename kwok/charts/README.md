...
| settings | object | `{"batchIdleDuration":"1s","batchMaxDuration":"10s","featureGates":{"launchBackoff":false,"nodeRepair":false,"spotToSpotConsolidation":false},"minValuesPolicy":"Strict","preferencePolicy":"Respect","schedulerConfig":""}` | Global Settings to configure Karpenter |
...
| settings.featureGates | object | `{"launchBackoff":false,"nodeRepair":false,"spotToSpotConsolidation":false}` | Feature Gate configuration values. Feature Gates will follow the same graduation process and requirements as feature gates in Kubernetes. More information here https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-gates-for-alpha-or-beta-features |
| settings.featureGates.launchBackoff | bool | `false` | launchBackoff is ALPHA and is disabled by default. Setting this to true will back off launches into capacity pools that returned insufficient capacity, and bound how fast a NodePool retries after one. |
